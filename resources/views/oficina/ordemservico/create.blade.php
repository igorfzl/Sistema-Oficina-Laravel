...
<div class="container mt-4">
    <div class="row mb-3">
        <div class="col-md-6">
            <h3>Registrar Nova Ordem de Serviço</h3>
        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" id="data_entrada" name="data_entrada" class="form-control" value="{{ old('data_entrada', date('Y-m-d')) }}" required>
                        </div>

                        <div class="mb-3">
                            <label for="data_saida_prevista" class="form-label">Previsão de Saída</label>
                            <input type="date" id="data_saida_prevista" name="data_saida_prevista" class="form-control" value="{{ old('data_saida_prevista') }}">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select id="status" name="status" class="form-select" required>
                                ...
                                <option value="Aguardando Peça" {{ old('status') == 'Aguardando Peça' ? 'selected' : '' }}>Aguardando Peça</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" id="produto_quantidade" name="produto_quantidade" class="form-control" value="{{ old('produto_quantidade') }}" placeholder="Obrigatório se selecionar um produto">
                        </div>

                        <div class="mb-3">
                            <label for="descricao_problema" class="form-label">Descrição do Problema</label>
                            <textarea id="descricao_problema" name="descricao_problema" class="form-control" rows="3">{{ old('descricao_problema') }}</textarea>
                        </div>
